...
def show_about_page():
    ...
    st.markdown(
        """
        WhatsApp Chat Analyser was created by [Likitha Yadav G]().
        You can find the source code on [https://github.com/LikithaYadavG]().
        """
    )
    ...
    st.markdown(
        """
        ---
        Made with ❤️ by Likitha Yadav G | Contact: likithayadavg@gmail.com
        """
    )
